...
export default function Home(propsRoute) {
    ...
    const renderMovies = () => {
        return listMovies.map((item, index) => {
            const { biDanh, dangChieu, danhGia, hinhAnh, hot, moTa, maPhim, ngayKhoiChieu, sapChieu, tenPhim, trailer } = item;
            ...
            return (
                <div className="p-4 lg:w-1/3" key={index}>
                    <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <h1 className="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">{moTa}</h1>
